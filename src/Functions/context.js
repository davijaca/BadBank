...
import { validateLogin, frmValidate, frmOnChange } from '../Middleware/process';
...
const Card = (props) => {
  ...
  return (
    <div className={cardClasses(bgcolor, txtcolor)} style={{margin: "3em", maxWidth: maxWidth ? maxWidth : maxWidthDefault}}>
